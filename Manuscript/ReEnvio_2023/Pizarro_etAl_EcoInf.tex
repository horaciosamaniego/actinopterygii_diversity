...
\begin{keyword}
Species Richness \sep Spatial and Teporal Representativeness \sep Marine Fish \sep Ecological Information Biases \sep Ecoinformatics
\end{keyword}
...
\subsection*{Acnlowledgement}
Funding for this research was provided by the National Agency of Research and Development of Chile through project FONDECYT Regular \#11211490 to HS. We thank professor Ricardo Giesecke for valuable comments on earlier versions of this manuscript.
...
\newblock \bibinfo{journal}{FAO Fisheries Synopsis} \bibinfo{volume}{10},
  \bibinfo{pages}{I}.
%Type = Article
\bibitem[{Costello and Chaudhary(2017)}]{costello2017marine}
\bibinfo{author}{Costello, M.J.}, \bibinfo{author}{Chaudhary, C.},
  \bibinfo{year}{2017}.
\newblock \bibinfo{title}{Marine biodiversity, biogeography, deep-sea
  gradients, and conservation}.
\newblock \bibinfo{journal}{Current Biology} \bibinfo{volume}{27},
  \bibinfo{pages}{R511--R527}.
\newblock \DOIprefix\doi{10.1016/j.cub.2017.04.060}.
%Type = Article
...
\begin{figure}[h]
\centering
\includegraphics[width=.99\textwidth]{FigS1}
